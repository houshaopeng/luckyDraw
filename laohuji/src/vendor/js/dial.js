	...
	var t = function(t, e) {
		...
		i = function() {
			...
			return e.prototype.on = function(t, e) {
				...
				if (this._queue[t]) {
					var n = void 0 === e ? -2 : this._queue[t].indexOf(e); - 2 === n ? delete this._queue[t] : -1 !== n && this._queue[t].splice(n, 1), this._queue[t] && 0 === this._queue[t].length && delete this._queue[t]
				}
				return this
		...
		r = function(t, e, n) {
			if (void 0 === t.style[e])
				for (var i = ["webkit", "ms", "moz", "o", null], r = 0; r < i.length; r++) {
					var o = i[r];
					if (!o) return null;
					if (e = function(t) {
			...
			return n && (t.style[e] = n), e
		},
		o = 0,
		s = window.requestAnimationFrame || window.msRequestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.oRequestAnimationFrame || function(t) {
		...
		a = window.cancelAnimationFrame || window.msCancelAnimationFrame || window.mozCancelAnimationFrame || window.webkitCancelAnimationFrame || window.oCancelAnimationFrame || function(t) {
			clearInterval(t)
		};
	return function(i) {
		function o(e, r) {
			...
			return s.options = Object.assign({
				...
				areaNumber: 8,
				deviation: 2
			}, r), s.pointer = e, s.init(), s
		}
		return e(o, i), o.prototype.init = function() {
			this._transform = r(this.pointer, "transform", "translate3d(0,0,0)"), r(this.pointer, "backfaceVisibility", "hidden"), r(this.pointer, "perspective", "1000px"), this._raf = null, this._runAngle = 0, this._targetAngle = -1
		}, o.prototype.reset = function() {
			var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "reset";
			this._raf && (a(this._raf), this._raf = null, this._runAngle = 0, this._targetAngle = -1, this.trigger(t), "reset" === t && r(this.pointer, this._transform, "translate3d(0,0,0) rotate(0deg)"))
		}, o.prototype.setResult = function(t) {
			var e = 360 / this.options.areaNumber,
				n = Math.random() * e;
			n = Math.max(this.options.deviation, n), n = Math.min(e - this.options.deviation, n), n = Math.ceil(n + t * e), this._runAngle = 0, this._targetAngle = n + 360 * (Math.floor(4 * Math.random()) + 4)
		}, o.prototype.step = function() {
			var t = this; - 1 === this._targetAngle ? this._runAngle += this.options.speed : (this._angle = (this._targetAngle - this._runAngle) / this.options.speed, this._angle = this._angle > this.options.speed ? this.options.speed : this._angle < .5 ? .5 : this._angle, this._runAngle += this._angle, this._runAngle = this._runAngle > this._targetAngle ? this._targetAngle : this._runAngle), r(this.pointer, this._transform, "translate3d(0,0,0) rotate(" + this._runAngle % 360 + "deg)"), this._runAngle === this._targetAngle ? this.reset("end") : this._raf = s(function() {
				return t.step()
			})
